...
<section class="hero-section w-full bg-gradient-to-br from-[#cfe9f3] via-[#e1f0f8] to-[#bde0eb] py-20 md:py-32 min-h-[700px] flex items-center overflow-hidden relative">
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            <h2 class="text-3xl font-bold text-gray-900 mb-10 text-center">Shop Our Top Categories</h2>
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                ...
                <div class="text-center group cursor-pointer">
                    <div class="bg-gray-50 rounded-xl p-6 mb-4 group-hover:shadow-xl transition-all duration-300 group-hover:-translate-y-2">
